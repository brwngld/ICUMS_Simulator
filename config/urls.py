...
admin.site.site_header = "ICUMS Simulator Administration"
admin.site.site_title = "ICUMS Simulator Admin"
admin.site.index_title = "Training platform administration"
